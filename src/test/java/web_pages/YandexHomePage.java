...
public class YandexHomePage {
    ...
    @FindBy(xpath = "//div[contains(@class, 'usermenu')]/ul[contains(@class, 'menu')]//following::li[last()]/a")
    private WebElement logout;

    private String password = "passp-field-passwd";
    private String userName = "//span[contains(@class, 'username ')]";
    private String avatarImage = "//a/span[contains(@class, 'wrapper')]/span[contains(@class, 'avatar__image')]";
    ...
    public void logOut(){
        WebDriverWait wait = new WebDriverWait(driver, 10);
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(avatarImage))).click();
        logout.click();
    }
